<template>
  <div
      class="bg-custom flex justify-center items-center text-center w-48 h-48 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
    <Numbers
        :test="test"
        v-model:test2="test2"
        :test3="test3"
  ...
  <button @click="up" class="p-4 border mx-8">up</button>
    <div
        class="bg-custom flex justify-center items-center text-center w-48 h-48 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
      <Numbers
          :test="test"
    ...
    <button @click="up" class="p-4 border mx-8">up</button>
    <div v-show="test2 > 4">
      <button @click="down" class="p-4 border mx-8">down</button>
      <div v-show="test2 > 4">
        <button @click="down" class="p-4 border mx-8">down</button>
      </div>
